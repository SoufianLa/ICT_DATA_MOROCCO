...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'Ictdata', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\Ictdata\\IctdataBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Utilisateurs\\UtilisateursBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Ictdata\\IctdataBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('IctdataBundle' => 'Ictdata\\IctdataBundle\\Entity', 'UtilisateursBundle' => 'Utilisateurs\\UtilisateursBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_e0186c7d07cee071d1fbb763486d62ad8cb7da77144e624b21242c1bada6d30b');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Ictdata\\IctdataBundle/Resources/views'), 'Ictdata');
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Ictdatachart\\chartBundle/Resources/views'), 'chart');
        $instance->addPath(($this->targetDirs[3].'\\src\\Admin\\AdminDashboardBundle/Resources/views'), 'AdminDashboard');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'IctdataBundle' => 'Ictdata\\IctdataBundle\\IctdataBundle',
                ...
                'chartBundle' => 'Ictdatachart\\chartBundle\\chartBundle',
                'AdminDashboardBundle' => 'Admin\\AdminDashboardBundle\\AdminDashboardBundle',
