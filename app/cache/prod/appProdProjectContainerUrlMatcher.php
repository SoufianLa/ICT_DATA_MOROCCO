    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/chart')) {
            ...
            if (0 === strpos($pathinfo, '/charte')) {
                ...
                // chart_efixe
                if ($pathinfo === '/chartefixe') {
                    return array (  '_controller' => 'Ictdatachart\\chartBundle\\Controller\\ChartemobileController::chartefixeAction',  '_route' => 'chart_efixe',);
                }

                // chart_ecomputer
                if ($pathinfo === '/chartecomp') {
                    return array (  '_controller' => 'Ictdatachart\\chartBundle\\Controller\\ChartemobileController::chartecomputerAction',  '_route' => 'chart_ecomputer',);
                }

                // chart_einternet
                if ($pathinfo === '/charteint') {
        ...
        // ictdata_showdata
        if ($pathinfo === '/showdata') {
            return array (  '_controller' => 'Ictdata\\IctdataBundle\\Controller\\IctdataController::showdataAction',  '_route' => 'ictdata_showdata',);
        }

        // ictdata_recherche
        if (0 === strpos($pathinfo, '/recherche') && preg_match('#^/recherche/(?P<a>[^/]++)/(?P<b>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'ictdata_recherche')), array (  '_controller' => 'Ictdata\\IctdataBundle\\Controller\\IctdataController::rechercheAction',));
        }
